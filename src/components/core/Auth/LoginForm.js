...
const LoginForm = () => {
  ...
  return (
    <form
      ...
      className="mt-6 flex w-full flex-col gap-y-4 text-richblack-5"
    >
      ...
      <label className="relative w-full">
        ...
        <input
          ...
          className="w-full rounded-[0.5rem] bg-richblack-800 p-[12px] pr-12 text-richblack-5 outline-none focus:ring-2 focus:ring-yellow-50"
        />
        <span
