...
//     //IMPORTANT FUNCTION VERY IMPORTANT  ,,,,,,,,,, DONT FORGET THIS Function
//     const setMyCards = (value) => {
//         setCurrentTab(value);
//         const result = HomePageExplore.filter((course)=>course.tag === value);   //MOST IMPORTANT LINE FOR SELECTING THE CARD AND BRINGING OUT THE DESIRED CARD
...
//   return (
//     <div className='flex flex-col iems-center w-full'>
...
//                 return (
//                     <div className={`flex flex-row items-center ${currentTab === element ?  "bg-richblack-900 text-richblack-50 font-medium":"text-richblack-200 "} hover:bg-richblack-800 hover:text-richblack-25 px-7 py-7 rounded-full transition-all duration-200 cursor-pointer`} key={index} onClick={()=>setMyCards(element)}>
//                         {element}
//                     </div>
//                 )
//             })
