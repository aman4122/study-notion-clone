...
//                         <img src={logo} alt="Study-Notion"className="h-10 mb-2"/>
    ...
    return (
        <footer className='bg-richblack-800 text-richblack-400 w-full mt-20'>
            ...
            <div className='mx-auto w-11/12 py-14 border-b border-richblack-600'>
                <div className='flex flex-row gap-10'>
                    ...
                    <div className='flex flex-row gap-10 flex-1'>
                        ...
                        {/* Logo + Company + Socials */}
                        <div className='flex flex-col gap-4 min-w-[150px]'>
                            <img src={logo} alt="StudyNotion" className='h-10 object-contain' />
                        ...
                        {/* Resources + Plans + Community + Support — 2x2 grid */}
                        <div className='grid grid-cols-2 gap-x-10 gap-y-10'>
                            <div className='flex flex-col gap-3'>
                                <h3 className='text-richblack-50 font-semibold text-sm'>{footerData[1].title}</h3>
                                {footerData[1].links.map((link) => (
            ...
            <div className='mx-auto w-11/12 py-6'>
                <div className='flex flex-row justify-between items-center text-sm flex-wrap gap-4'>
                    <div className='flex gap-4 items-center'>
                        <Link to={"/"} className='hover:text-richblack-50 transition-all duration-200'>Privacy Policy</Link>
                        <span>|</span>
                        <Link to={"/"} className='hover:text-richblack-50 transition-all duration-200'>Cookie Policy</Link>
                        <span>|</span>
