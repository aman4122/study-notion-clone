    ...
    <div className="text-white">
      ...
      {enrolledCourses.length === 0 ? (
        ...
        <div className="flex flex-col gap-4">
          {/* Header */}
          <div className="grid grid-cols-3 px-4 py-2 text-richblack-400 text-sm font-medium border-b border-richblack-700">
            <span>Course</span>
          ...
          {enrolledCourses.map((course) => (
            <Link
              ...
              key={course._id}
              className="grid grid-cols-3 items-center px-4 py-4 bg-richblack-800 rounded-lg border border-richblack-700 hover:border-yellow-50 transition-all"
            >
              {/* Course Info */}
              ...
              <div className="flex flex-col items-end gap-1">
                <span className="text-richblack-300 text-sm">0% Complete</span>
                <div className="w-32 h-2 bg-richblack-700 rounded-full">
                  <div className="h-2 bg-yellow-50 rounded-full w-0" />
                </div>
              </div>
            </Link>
          ))}
